export async function onRequestPost({request,env}){
  ...
  const result=await env.DB.prepare('INSERT INTO "main"."table" (artist,session_id,song_name,song_video,segment_saved) VALUES (?,?,?,?,?)').bind(artist,null,title,url,start).run();
